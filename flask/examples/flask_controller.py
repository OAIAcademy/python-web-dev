...
@app.get('/hello')  # defining a get endpoint
def hello():
    return 'Hello, World!'  # returning a string in the http response


@app.post('/')
def test():
    print(request.get_json())  # read requests details
    print(request.headers)
    print(request.args)
    return request.get_json()  # returning json
